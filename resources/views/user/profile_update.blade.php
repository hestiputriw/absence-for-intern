            ...
            <div class="profile-content">
                <div class="row owner-profile row-profile justify-content-center">
                    <div class="col-md-4 col-sm-4 col-xs-6 text-center">
                        <div class="avatar">
                            <img src="{{ asset('img/logo-small.png') }}" alt="Circle Image"
                                class="img-circle img-no-padding img-responsive">
                        </div>
                        <div class="name">
                            <h3>{{ Auth::user()->name }}<br /><small><i class="fa fa-university"></i>
                                    {{ Auth::user()->institute }}</small></h3>
                        </div>
                    </div>
                </div>
                <div class="row row-profile justify-content-center">
                    <div class="col">
                        <a href="{{ url("user/profile") }}" class="btn btn-info btn-fill btn-block btn-top"><i
                ...
                <div class="card card-profile">
                    <form class="register-form" action="{{url('user/profile/update')}}" method="POST">
                        ...
                        <input type="text" class="form-control color-text top" placeholder="Institute"
                            value="{{ Auth::user()->institute }}" name="institute">
                        @error('institute')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span><br>
