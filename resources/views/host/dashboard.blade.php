                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-5 col-md-offset-3">
                                    <img src="{{ asset('img/presin.png') }}" alt="Rounded Image" class="img-rounded img-responsive linef">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-5 col-md-offset-4">
                                    <a href="{{ url("host/presence/in") }}" class="btn btn-fill btn-danger linef">Presence In</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-5 col-md-offset-3">
                                    <a href="{{ url("host/presence/out") }}" class="btn btn-fill btn-danger liner">Presence Out</a>
                                </div>
                            </div>
                        </div>
                    </div>
